...
samy76 y, subject(id) model(3) time(time) /*usetrt*/ visit(visit) treat(trt) schedule(1 5) iter(`iter') alpha(`alpha') n(200)  dropout(0.1 0.1) effectiveness(`eff1') // scale(365.25)
